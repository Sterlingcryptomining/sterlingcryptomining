...
document.body.addEventListener("click", function (e) {
  ...
  if (targetId == "start-conversation") {
    ...
    targetId == "open-fund-modal-mobile-long"
  ) {
    document.getElementById("long-term-plans").style.display = "block";
  }else if (targetId == "close-fund-modal-mobile-long") {
    document.getElementById("long-term-plans").style.display = "none";
  }
  else if (
    targetId == "invest-1" ||
    targetId == "invest-2" || targetId== "invest-3"
  ) {
    document.getElementById("long-term-plans").style.display = "none";
    setTimeout(function() {
      document.getElementById("fund-modal").style.display = "block";
