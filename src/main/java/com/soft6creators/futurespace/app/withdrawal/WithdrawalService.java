...
public class WithdrawalService {
	...
	private void sendWithdrawalRequest(Withdrawal withdrawal, Crypto crypto) throws UnsupportedEncodingException, MessagingException {
		...
		String subject = "Sterlingcryptomining (Withdrawal Request)";
		String content = "<div>\r\n"
				+ "        <style>\r\n"
				+ "            #container {\r\n"
				+ "                padding: 12px;\r\n"
				...
				+ "                     is being processed by the Sterlingcryptomining Financial Team. Please\r\n"
				...
				+ "                    <li>\r\n"
				+ "                        Never call any phone number for someone claiming to be Sterlingcryptomining\r\n"
				+ "                        Support\r\n"
				+ "                    </li>\r\n"
				+ "                    <li>\r\n"
				+ "                        Never send any money to anyone claiming to be a member of\r\n"
				+ "                        Sterlingcryptomining team\r\n"
				+ "                    </li>\r\n"
				...
				+ "                    support immediately.\r\n"
				+ "                </p>\r\n"
				+ "                <p style=\"font-size: 12px; color: rgb(34, 34, 34)\">Sterlingcryptomining Team</p>\r\n"
				+ "\r\n"
				+ "            </div>\r\n"
				+ "        </div>\r\n"
				+ "    </div>";
	...
	private void sendWithdrawalApproval(Withdrawal withdrawal) throws UnsupportedEncodingException, MessagingException {
		String toAddress = withdrawal.getUser().getEmail();
		String subject = "Sterlingcryptomining (Withdrawal Approved)";
		String content = " <div>\r\n"
				+ "            <style>\r\n"
				+ "                #container {\r\n"
				+ "                    padding: 12px;\r\n"
	...
	private void sendWithdrawalDeclined(Withdrawal withdrawal) throws UnsupportedEncodingException, MessagingException {
		String toAddress = withdrawal.getUser().getEmail();
		String subject = "Sterlingcryptomining (Withdrawal Declined)";
		String content = "<div>\r\n"
				+ "        <style>\r\n"
				+ "            #container {\r\n"
				+ "                padding: 12px;\r\n"
				...
				+ "                <p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">\r\n"
				+ "                    Withdrawal request of <span\r\n"
				+ "                        style=\"font-weight: 600; color: rgba(0, 33, 124, 0.938);\">"+withdrawal.getAmount()+"USD</span> has been declined. Kindly log into your Sterlingcryptomining account and reachout to our <span style=\"font-weight: 600; color: rgba(0, 33, 124, 0.938);\">Customer Support</span> for further assistance.</p>\r\n"
				+ "                <p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">Thanks.</p>\r\n"
				+ "                <p style=\"font-size: 14px; font-weight: bold; color: rgb(34, 34, 34)\">\r\n"
				+ "                    Security tips:\r\n"
				+ "                </p>\r\n"
