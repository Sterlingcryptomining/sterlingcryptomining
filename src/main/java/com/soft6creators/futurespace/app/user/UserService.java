...
public class UserService {
	...
	private void sendVerificationEmail(User user) throws MessagingException, UnsupportedEncodingException {
		...
		String subject = "Sterlingcryptomining (One time password)";
		String content = " <div>\n"
				+ "        <style>\n"
				+ "            #container {\n"
				...
				+ "                    Welcome to Sterlingcryptomining\n"
				+ "                </p>\n"
				+ "                <p style=\"font-size: 14px; color: rgb(34, 34, 34)\">\n"
	...
	private void sendResetEmail(String email) throws MessagingException, UnsupportedEncodingException {
		...
		String subject = "Sterlingcryptomining (Password Reset)";
		String content = " <div>\n"
				+ "        <style>\n"
				+ "            #container {\n"
				+ "                padding: 12px; font-family: Arial, Helvetica, sans-serif;\n"
				...
				+ "                </p>\n"
				+ "                <p style=\"font-size: 14px; color: rgb(34, 34, 34)\">\n"
				+ "                    Sterlingcryptomining Password Reset\n"
				+ "                </p>\n"
				+ "                <p style=\"font-size: 14px; color: rgb(34, 34, 34)\">\n"
